...
export default function PublicImgs(){
  ...
  if(img !== null){
    ...
    const startDownLoad = async (e) =>{
      e.preventDefault()
      if(window.confirm("Click ok to see full resolution")){
        let date = new Date()
        let stamp = date.getMilliseconds.toString()
        let imgName = `${stamp}.png`
        saveAs(url, imgName)
      }
    }
        ...
        <section className="bottom-imgs-buttons">
          {
            user_imgs_array.map((item, idx)=>{
                return(
                  <button onClick={(e)=>{startDownLoad(e)}} className="user-imgs-actual-button"  key={idx}>
        ...
        <section className="bottom-imgs-buttons">
          {
            user_imgs_array.map((item, idx)=>{
                return(
                  <button className="user-imgs-actual-button"  key={idx}>
                    <img className="user-imgs" src={item} alt={`img_${idx}`} />
                  </button>
                )
            })

...
import { seaHack, aiHack2, aiHack3, techEvent } from "../../global/images/community/communityCollection";
import cheriRecomendation from "../../global/images/community/coaching/professorTestimony.png";
import jamey_recomendation from "../../global/images/community/coaching/jamey_coaching.png";
import CarouselBuilder from "../../global/components/carousel/carouselBuilder"
// import Button from 'react-bootstrap/Button';
import linkin from '../../global/images/icons/tech/linkedin.png';
import youtube from '../../global/images/icons/tech/youtube.png';
import './index-section-5.css';
...
export default function LandingSection5() {
  ...
  return(
      <div id="section-5" className="communityContainer">
        ...
        <div className="coaching">
          ...
          <div className="coachingContainer">
            <div className="coachingTextBody">
              ...
              <div className="coachingTestomonies-container">
                <button  className="cheriMoreCommunity" onClick={(e)=>cheriPopUp(e)}>View Mentioned Project</button>
                ...
                <img className="jaymey_recomendation_community" src={jamey_recomendation} alt="LinkedInRecommendation" />
              </div>
            </div>
          </div>
        </div>
        <div className="techEvents">
          ...
          <div className="techEventsContainer">
                ...
                <div className="hackathonTextBody">
                  ...
                  <p className="indent">Engaging with like-minded individuals in the tech community has been transformative. Embracing diverse perspectives and benefitting from mentorship opportunities have played a significant role in my personal and professional development. The willingness of community members to share their knowledge and support others has created an environment where learning and growth are actively encouraged. I am always in the search for more events if you know of any others send me and invite!
                  </p>
                </div>
            </div>
        </div>
        <div className="externalCommunityBtn">
          <button className="externalButtons communityConnection" href="https://www.linkedin.com/in/carlitos206/"><img className="connectionIcons linkedInIcon"src={linkin} alt="LinkedIn" /></button>
          <button id="youtubeBtn" className="externalButtons communityConnection" href="https://www.youtube.com/channel/UCfJtIgTcGEX_D0TLjFi-COQ"><img className="connectionIcons youtubeIcon"src={youtube} alt="YouTube" /></button>
        </div>
      </div>
  )
}
  ...
  return (
    ...
    <div className="uwEcommerceContainer">
      ...
      <div className="uwEcommerceBody">
        ...
        <p className="uwEcommerceText indent">With the connection in hand I now had to now build the client side. I started with the admin side of the site. I had to plan on how I was going to upload images, that's of course one of the limitations of the Firestore being a document database therefore it does not  have the ability to hold files only text based data. So I discovered Firebase Storage, this was great news because I was able to hold everything in the same ecosystem. But since they are two separate services I had to make them co-dependent, this was a challenge. It took lots of testing, now that I look at the code the answer and concept is second nature, making functions co-dependent or simply asynchronous as it is known was a large wave of mental gymnastics that I had to complete, that was the first challenge I truly felt was worthy of my skills. How the functions worked was simple, I first uploaded the image to Firebase Storage, that returns a url reference to the image, the image url reference is then added to the object being sent to Firebase Firestore. When the document in Firestore is called to be rendered since it's an image url, it's now usable in the HTML.</p>

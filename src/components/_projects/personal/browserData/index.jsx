...
import CustomCarouselBuilder from "./customCarousel";
import { imgCollection } from "../../../global/images/userAgent/collection";
import img_0 from "../../../global/images/userAgent/firbaseCollection/img_0.png"
    ...
    <Nav source={'other'} />
      <div className="bd_container">
        ...
        <div className="bd_article indent">
          ...
          <CustomCarouselBuilder images={imgCollection}/>

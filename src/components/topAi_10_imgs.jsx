...
export default function TopImgs(){
    ...
    return(
      <section className="top-imgs-container section-background-light container-shape elevate">
        <section className="top-imgs-header">
          <section className="openai_svgs">
            <svg className="openAi-logo" width="200px" id="openai-horizontal" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 29.53">
            ...
            <svg className="openAi-logo"width="200px" viewBox="0 0 417 69" xmlns="http://www.w3.org/2000/svg"><g>
        ...
        <section className="top-imgs-buttons">
          {
            ai_imgs_only_list.map((item, idx)=>{
              if(idx % 3 === 0){
                return(
                  <button className="top-imgs-actual-button"  key={idx} onClick={(e)=>{setIdx(idx)}}>
                    <img className="top-imgs" src={item} alt={`img_${idx}`} />
                  </button>
                )
              }else{
                return(
                  <button className="top-imgs-actual-button remove-img" onClick={(e)=>{setIdx(idx)}} key={idx}>
                    <img className="top-imgs" src={item} alt={`img_${idx}`} />
                  </button>
                )
              }

  ...
  return(
      <div className="bd_container">
        <div className="bd_title">
          ...
          <p className="bd_project_outline_text">Projects Outlined in Article: <a href="#">User Agent in Python Django plug in tool</a>,  
              <a href="#missig"> Portfolio{'(Deprecated)'}</a>, 
              <a href="#"> UW Course 1 Final</a>,
              <a href="#"> UW Course 2 Final</a>
          </p>
        </div>
        <div className="bd_article indent">
          ...
          <p className="bd_article_text">Do you want to see your reflection? <a href="#" className="bd_sourceCodeLink_text">Source Code</a> </p>

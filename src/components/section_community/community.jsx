        ...
        <div className="techEvents">
          ...
          <div className="techEventsContainer">
                ...
                <div className="hackathonTextBody">
                  ...
                  <p className="indent">Engaging with like-minded individuals in the tech community has been transformative. Embracing diverse perspectives and benefitting from mentorship opportunities have played a significant role in my personal and professional development. The willingness of community members to share their knowledge and support others has created an environment where learning and growth are actively encouraged. I am always in the search for more events if you know of any others <a href="/contact">send me and invite</a>
                  </p>
                </div>
            </div>
        </div>
